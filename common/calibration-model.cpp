...
bool calibration_model::supports()
{
    ...
    bool is_al_roboteye = (pidstr.compare("99AA") == 0 || pidstr.compare("99BB") == 0 || pidstr.compare("99C0") == 0 || pidstr.compare("99C1") == 0) ? true : false;// (dev.get_info(RS2_CAMERA_INFO_PRODUCT_ID) == "99AA") ? true : false;
